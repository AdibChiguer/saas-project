              ...
              {loading && devisList.length === 0 ? (
                ...
                devisList.map((devis) => (
                  <tr key={devis.id} className="hover:bg-zinc-50/50 dark:hover:bg-zinc-800/50 transition-colors group">
                    <td className="p-4 md:p-6 font-mono font-black text-sm md:text-base text-zinc-900 dark:text-zinc-100">{devis.numero}</td>
                    <td className="p-4 md:p-6">
                      <div className="flex items-center gap-3">
                        ...
                        <span className="font-bold text-sm md:text-base text-zinc-700 dark:text-zinc-300 truncate max-w-[120px] md:max-w-none">{devis.client.nom}</span>
                      </div>
                    </td>
